...
- **[明日新程团队](https://github.com/mingrixinli)** - 开发了原创的 **卫士虾 (WeishiXia)** 安全内核，为本项目提供了灵感和基础
...
**TuanziGuardianClaw v2** 基于 **卫士虾 (WeishiXia)** 开发并受到其启发——卫士虾是由 [明日新程团队](https://github.com/mingrixinli) 开发的创新安全内核。我们向原作者表示诚挚的感谢，感谢他们在 AI Agent 安全领域的开创性工作。
